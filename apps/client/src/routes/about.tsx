...
function AboutPage() {
  ...
  return (
    <main id="main-content" tabIndex={-1} className="relative isolate">
      ...
      <div className="relative z-1 mx-auto w-[min(1120px,calc(100%-2rem))] pt-[clamp(2rem,5vw,3rem)] pb-16">
        <section
          aria-labelledby="about-title"
          className="grid gap-4 pt-4 motion-safe:animate-in motion-safe:fade-in motion-safe:slide-in-from-bottom-[18px] motion-safe:duration-720 motion-safe:ease-[cubic-bezier(0.22,1,0.36,1)]"
        >
          <Badge
            variant="outline"
          ...
          <h1
            id="about-title"
            className="mt-[0.65rem] text-balance text-[clamp(2.6rem,6vw,5rem)] leading-[0.97] tracking-[-0.06em]"
          >
            {m.about_hero_title()}
          </h1>
        ...
        <section
          ...
          className="pt-[clamp(3.5rem,9vw,6rem)]"
        >
          <div>
            <Badge
              variant="outline"
            ...
            <h2
              ...
              className="mt-[0.85rem] text-balance text-[clamp(1.7rem,3vw,2.5rem)] leading-[1.05] tracking-[-0.04em]"
            >
          ...
          <div className="mt-8 grid grid-cols-3 gap-4 max-[960px]:grid-cols-1">
            {architecturePrinciples.map((principle, index) => (
              <article
                key={principle.title}
                className="rounded-[1.6rem] border border-(--landing-border) bg-(--surface-panel) p-[1.35rem] backdrop-blur-md motion-safe:animate-in motion-safe:fade-in motion-safe:slide-in-from-bottom-[18px] motion-safe:duration-720 motion-safe:ease-[cubic-bezier(0.22,1,0.36,1)]"
        ...
        <section
          aria-labelledby="about-packages-title"
          className="grid grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)] items-start gap-[clamp(1.75rem,4vw,3rem)] pt-[clamp(3.5rem,9vw,6rem)] max-[960px]:grid-cols-1"
        >
          <div>
            <Badge
              variant="outline"
        ...
        <section
          aria-labelledby="about-bootstrap-title"
          className="pt-[clamp(3.5rem,9vw,6rem)]"
        >
          <div>
            <Badge
          ...
          <div className="mt-8 grid grid-cols-3 gap-4 max-[960px]:grid-cols-1">
            <article className="rounded-[1.6rem] border border-(--landing-border) bg-(--surface-panel) p-[1.35rem] backdrop-blur-md motion-safe:animate-in motion-safe:fade-in motion-safe:slide-in-from-bottom-[18px] motion-safe:duration-720 motion-safe:ease-[cubic-bezier(0.22,1,0.36,1)]">
              <h3 className="m-0 text-[1.05rem] tracking-[-0.03em]">
