  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <Card className="ring-border">
        <CardHeader><CardTitle>Patch Report</CardTitle><CardDescription>The evidence-backed answer to what changed, what ran, and what happens next.</CardDescription></CardHeader>
      ...
      <div className="grid gap-5 lg:grid-cols-2">
        <Card className="ring-border">
          <CardHeader><CardTitle className="flex items-center gap-2"><FileCheckIcon />Requested change</CardTitle><CardDescription>Original request attached to this report.</CardDescription></CardHeader>
          <CardContent><p className="m-0 whitespace-pre-wrap text-sm leading-relaxed">{detail.promptRequest.prompt}</p></CardContent>
        </Card>
        <Card className="ring-border">
          <CardHeader><CardTitle className="flex items-center gap-2"><ShieldCheckIcon />Automated verdict</CardTitle><CardDescription>Review and policy results before the human decision.</CardDescription></CardHeader>
