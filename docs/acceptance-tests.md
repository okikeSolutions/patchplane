...
| M9.75     | Missing, blocked, errored, persistently mutated, final-HEAD-drifted, platform-unavailable, truncated, or mismatched required evidence is never reported as passed                                                                                                                                                    | core exact-HEAD/final-state invalidation plus verification coverage, policy, report, and UI tests                       | Automated |
