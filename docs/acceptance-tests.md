...
| M9.75     | GitHub PR intake freezes the webhook-authenticated base/head candidate and exact diff before Daytona or Pi starts                          | domain/intake/core tests plus credentialed PR dogfood        | Missing   |
