...
| --------------------- | --------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| Candidate identity    | Immutable attempts, webhook-authenticated base/head pinning, sandbox-generated candidate digest                       | PatchPlane-owned incoming-PR subject schema and base/head attempt persistence are implemented                                             | Exact `base...head` capture and durable candidate freeze before verification                                     | Implement R2-backed incoming-candidate capture and pre-dispatch persistence   |
...
| CAND-003 | P0       | Explicit alpha PR candidate subject            | PatchPlane-owned candidate-subject schemas distinguish incoming PR and sandbox-generated origins; incoming identity includes normalized repository, PR, base/head, and source-event fields | PatchPlane-owned schema identifies an incoming PR candidate by repository, PR, base SHA, head SHA, exact diff digest, and source event without provider objects crossing core | Implemented | `candidate-subject.ts` and domain composition tests; runtime incoming-candidate persistence remains in `CAND-005` | CAND-005                                |
