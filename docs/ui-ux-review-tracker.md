...
Reconstructed on 2026-07-26 from the current implementation, focused
...
| ---------------------- | ---------------------------------------------- | ------------------------------------------------------------------------------------- | ---------------------------------------------- | ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Core UI/UX             | UX-001–UX-012, UX-029, UX-033                  | UX-013 (`In progress`), UX-014 (`In progress`)                                        | UX-015, UX-030–UX-032                          | UX-016–UX-028     | Complete manual screen-reader, zoom, and responsive accessibility acceptance rather than reopening verified header, queue, trust, retrieval, deployment-freshness, or scroll-end spacing work. |
| Diff viewer            | DIFF-001–DIFF-003, DIFF-005, DIFF-007          | DIFF-004 and DIFF-006 authenticated evidence; DIFF-008 manual acceptance remains open | DIFF-004, DIFF-006, DIFF-008                   | DIFF-009–DIFF-012 | Capture the remaining authenticated screenshots/network waterfall, then complete 200% zoom and manual screen-reader readback for DIFF-008.                                                     |
| Changed-file navigator | TREE-001–TREE-002, TREE-005, TREE-007–TREE-009 | TREE-003–TREE-004 and TREE-006 authenticated browser evidence remains                 | TREE-003–TREE-004, TREE-006, TREE-010–TREE-011 | —                 | Complete authenticated accessibility review for the full beta interaction surface.                                                                                                             |
...
- The latest full `bun run verify` passes, including 148 client tests, client
  and server production builds, and Cloudflare bundle budgets. The production
  client remains 12.92 MiB total and 2.68 MiB JavaScript gzip, with a 1.33 MiB
  largest raw JavaScript chunk. The server bundle remains 7.27 MiB against its
  7.5 MiB ceiling.
...
| UX-013 | P1       | Accessibility             | The diff viewer has no defined keyboard or screen-reader navigation model.                                                                                                         | Define file navigation, line announcements, focus restoration, expand/collapse behavior, and unified/split mode labels.                                                                                                                                                                                                                                                       | A keyboard-only reviewer can select files, traverse the diff, and return to the file navigator without losing position.                                                                                                                                                                                                                       | In progress | Semantic transcript and focus contracts are implemented; manual acceptance remains                     |
| UX-014 | P1       | Mobile                    | The shell collapses, but unbounded titles and source bodies still dominate the mobile report and workflow cards.                                                                   | Apply the same bounded-content hierarchy on mobile. Present the changed-file navigator as a drawer or sheet.                                                                                                                                                                                                                                                                  | The verdict, title, change size, and Changes action fit in the initial mobile flow without horizontal scrolling.                                                                                                                                                                                                                              | In progress | Responsive audit at 390 × 844                                                                          |
...
| UX-028 | P0       | Candidate coherence       | The diff experience does not define what happens when evidence is stale, mutated, candidate-mismatched, or superseded by a newer attempt while the report is open.                 | Pin the viewer to the selected attempt and candidate. Show a blocking coherence state and an explicit link to the newer attempt; never silently replace the reviewed candidate or reuse another candidate's evidence.                                                                                                                                                         | Stale, mutated, mismatched, and superseded fixtures fail closed; the displayed attempt, candidate digest, diff artifact, review, policy, and decision remain coherent, and navigation to a newer attempt is intentional.                                                                                                                      | Not started | `SPEC.md` attempt/candidate identity and fail-closed rules; M9.75/M10 acceptance matrix                |
...
| UX-013 | Client                    | DIFF-004, DIFF-008, TREE-003, TREE-006                    | Keyboard and screen-reader acceptance                                                                          | Renderer-independent interaction, focus restoration, tree navigation, mobile overlay behavior, and line announcements are implemented in the current adapters. Authenticated inspection confirms named file/diff regions and an ordered hunk/line transcript without per-line tab stops. Manual screen-reader readback, 200% zoom, and the 390 × 844 pass remain before verification.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| UX-014 | Client                    | UX-001, UX-002, UX-004, TREE-007                          | Responsive-web acceptance at 390 × 844                                                                         | The compact report header now includes a `Changes` action beside the trust verdict and exposes persisted file, addition, and deletion counts in both visible and explicit screen-reader language. Candidates without persisted statistics show no invented size. The unbounded original request is collapsed behind the shared `Collapsible` and `Button` primitives by default, remains intentionally available, and wraps unbroken content safely. Component regressions cover the title, count label, disclosure semantics, request absence before expansion, and direct Changes navigation; `bun run verify` passes with 115 client tests and a 728 KiB / 762 KiB client JavaScript budget. Authenticated dev readback on 2026-07-26 confirmed the audited historical candidate exposes the honest `View Changes` fallback, direct navigation to Changes, a collapsed request body, and zero horizontal overflow at the available desktop viewport. Authenticated 390 × 844 evidence and the TREE-007 changed-file drawer remain pending, so this row is not yet `Verified`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| UX-017 | Client + Telemetry        | DIFF-010                                                  | Sentinel-content transport tests                                                                               | Pending                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| UX-018 | Product Design + Client   | Compact report composition                                | Desktop visual review                                                                                          | Pending                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| UX-021 | Client                    | Fixture harness                                           | Direct-tab loading and announcement tests                                                                      | Pending                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| UX-022 | Client + Artifacts        | Structured artifact error contract                        | Artifact error state-matrix tests                                                                              | Pending                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| UX-023 | Client                    | File identity and navigation contract                     | URL/local-state navigation tests                                                                               | Pending                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| UX-024 | Product Design + Client   | Semantic token review                                     | Contrast, non-color state, and visual tests                                                                    | Pending                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| UX-025 | Intake + Client           | UX-001                                                    | Markdown security tests and authenticated Summary readback                                                     | Pending                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| UX-026 | Client                    | Existing UI inventory                                     | Component import/inventory review and browser evidence                                                         | Pending                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| UX-028 | Domain + Client           | DIFF-003 and coherent attempt projection                  | M9.75/M10 stale, mutated, mismatched, and superseded state tests                                               | Pending                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
### DIFF-004 unified alpha renderer
...
Unified mode is explicit rather than inherited from Pierre because the package
defaults to split rendering. The alpha configuration uses classic `+`/`-`
indicators, metadata hunk separators, visible line numbers, horizontal overflow
for long lines, system light/dark themes, and the local mono/sans font tokens.
Pierre's duplicate file header is disabled because the PatchPlane file heading
is the navigation and focus target.

Split mode is intentionally not exposed. No available-width screenshot,
keyboard, zoom, or screen-reader evidence currently proves that two code columns
remain usable beside the changed-file navigator and review rail. A future split
toggle must pass those gates before it can appear; DIFF-004 does not silently
store or advertise an unavailable preference.

Automated verification on 2026-07-26 renders the real Pierre Shadow DOM for two
candidate files, asserts both hosts use the unified `single` layout rather than
`split`, and confirms tree selection still updates selected state, scrolls the
matching section, and focuses its heading. Focused renderer, Changes, and
architecture suites pass with 30 tests. Authenticated dev-stage screenshots
remain pending. The production bundle check passes at 12.80 MiB total and
2.64 MiB JavaScript gzip for the client, with Pierre isolated in a 434 KiB raw
lazy adapter chunk; the server remains 6.82 MiB. DIFF-004 is therefore
...
Authenticated dev inspection on 2026-07-26 confirmed two named hunk regions,
...
1,512 × 778. Automatic loading is now owned by
...
manual screen-reader readback of one added, deleted, and unchanged line, 200%
browser zoom, and the 390 × 844 authenticated responsive pass required by the
...
| DIFF-009 | Failure states | Wrap parser and worker failures in PatchPlane's unavailable/malformed evidence states.                                                                                                                                                                                                  | Component regression tests                                  | Not started |
| DIFF-010 | Telemetry      | Prevent raw code, raw diff lines, and sensitive artifact content from reaching Sentry or PostHog.                                                                                                                                                                                       | Sentinel-content transport tests                            | Not started |
...
navigation landmark, and managed-runtime projection boundary. Authenticated
dev-browser interaction remains pending, so TREE-003 is `Implemented`, not yet
`Verified`.
...
The verified workspace was deployed to the `dev` stage from HEAD
`bfee74ac204661ce7e65b45c14786ae861b5e18b`; only the Client and
SourceControlWorker changed. The navigator and renderer source SHA-256 values
are `3c46861926223d74eb2fa560420e61475e89dd5adede6c3b2f59b021e1ccc243` and
`94b44a4c429a719437b77badf38567e36fbe11aaf7183f32a2b13f6b5117678f`.
Authenticated readback reached the Changes tab, but both load and retry for
workflow `ms76g9ahz6hbsr31xbynkz5pa58b7c68` returned the explicit
`Diff could not be retrieved` state before the navigator could mount.
Consequently native Enter activation, the deployed accessibility tree, 200%
zoom, and manual screen-reader speech remain open. TREE-006 is `Implemented`,
not `Verified`.
...
| TREE-003 | Navigation     | Selecting a file scrolls or focuses its rendered diff and updates selected state.                                                                                                                                                            | Browser interaction test                                  | Implemented |
...
| 3     | Render the PR body as sanitized GitHub-flavored Markdown              | Not started    | Summary is readable and unsafe provider markup cannot execute                                  |
